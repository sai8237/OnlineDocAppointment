...
<html lang="en">
  ...
  <div class="collapse navbar-collapse " id="navbarNav">
    ...
    <td><button class="button button1"><a href="/admin/changestatus/${admin.bookId}" >Change Status</a></button></td>
    <td><button class="button button1"><a href="/admin/delete/${admin.bookId}" >Delete</a></button></td>
    </tr>
    </c:forEach> 
    </table>
