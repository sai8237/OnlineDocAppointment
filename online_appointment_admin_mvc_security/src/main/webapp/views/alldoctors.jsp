...
<html lang="en">
    ...
    <ul class="navbar-nav ml-auto text-uppercase">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/admin/patients">Patients</a>
         ...
         <li class="nav-item">
        <a class="nav-link" href="/admin">Appointments</a>
      </li>
      <li class="nav-item">
 ...
 <p><header class="jumbotron">
    ...
    <p><h1>Registered Doctors </h1></p>
	<table border="2" width="70%" cellpadding="2" align="center">
	          
	<tr><th>DoctorName</th><th>Category</th><th>Mobile Number</th><th>Fees</th><th>E-mail</th><th>Delete</th></tr>
    ...
    <td>${doctor.fee}</td>
    <td>${doctor.email}</td>
     <td> <button class="button button1"><a href="/admin/deletedoctor/${doctor.email}" >Delete</a></button></td>
    </tr>
    </c:forEach>
    </table>
