...
<html lang="en">
  ...
  <div class="collapse navbar-collapse " id="navbarNav">
    ...
    <p><h1>Registered Patients </h1></p>
	<table border="2" width="70%" cellpadding="2" align="center">
	<tr><th>Name</th><th>Email</th><th>Age</th><th>Mobile</th><th>Gender</th><th>Delete</th></tr>
    ...
    <td><button class="button button1"><a href="/admin/deletepatient/${patient.email}" >Delete</a></button></td>
    </tr>
    </c:forEach> 
    </table>
