...
.button1:hover {
  ...
  <p><header class="jumbotron">
	...
	<tr><th>BookId</th><th>DoctorName</th><th>PatientName</th><th>Payment</th><th>Status</th><th>DateTime</th><th>Delete</th></tr>
    <c:forEach var="apt" items="${appoList}"> 
    <tr>
    <td><a href="/feedback/${apt.bookId}">${apt.bookId}</a></td>
